// Self-contained UI transcript parser (adapter-ui-parser contract v1).
// Inlined from ui/parse-stdout.ts so the module has zero imports — the
// plugin loader extracts this file's source and evaluates it in the UI.
...
function parseOpenCodeStdoutLine(line: string, ts: string): TranscriptEntry[] {
...
// ESM export for TypeScript/UI bundle
export { parseOpenCodeStdoutLine };

// CommonJS export for the sandboxed parser worker bootstrap
module.exports = { parseOpenCodeStdoutLine };
